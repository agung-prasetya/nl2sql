...
for path in paths:
    ...
    for entity in data['entities']:
        attribute_name_type = {}
        for atribut in data['entities'][entity]['attributes']:
            attribute_name_type[atribut.lower()] = data['entities'][entity]['attributes'][atribut].lower() 
        entitas_attributes[entity] = attribute_name_type
